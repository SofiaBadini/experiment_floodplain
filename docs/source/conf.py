...
project = "Information Frictions, Overconfidence, and Learning: Experimental Evidence from a Floodplain"
copyright = "2023-, Sofia Badini"
...
modindex_common_prefix = ["experiment_floodplain."]
...
html_css_files = ["css/custom.css", "css/s4defs-roles.css"]
...
latex_elements = {
    ...
    # Index is one column, right-aligned, and footnote size
    'printindex': '\\def\\twocolumn[#1]{#1}\\footnotesize\\raggedright\\printindex',
    # Python Module index is one column
    'makeindex': '\\usepackage[columns=1, font=small]{idxlayout}\\makeindex'
}
